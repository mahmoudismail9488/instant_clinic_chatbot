...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-4XQzpUL0.js
var server_4XQzpUL0_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DgzYYbKm.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-cVTBtxXh.mjs").then((n) => n.t),
		import("./start-CpLWMHeG.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_4XQzpUL0_exports as t };
